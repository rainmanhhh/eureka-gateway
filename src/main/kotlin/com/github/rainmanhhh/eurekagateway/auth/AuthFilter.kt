...
import com.github.rainmanhhh.eurekagateway.extension.thr
import com.github.rainmanhhh.eurekagateway.filter.CoroutineWebFilter
import com.github.rainmanhhh.eurekagateway.block.BlockUserController
import com.github.rainmanhhh.eurekagateway.block.UserIsBlockedException
import com.github.rainmanhhh.eurekagateway.rule.Rule
import com.github.rainmanhhh.eurekagateway.rule.RuleService
    ...
    for (rule in ruleList) {
      if (rule.match(path)) {
        ...
        if (checkResult) return true
          ...
          if (priority > 0) HttpStatus.FORBIDDEN.thr(RuleCheckError(rule))
